...
split = sample.split(dataset$purchased, SplitRatio = 0.75) #Splitting data here into training and test sets.
...
#Cross validation is a ML thing. Divides data into say multiple frames, say 4 frames of 100 obvs each in this case, and makes all possible combos of training and test sets. It's the best technique.
...
#Model is 84% accurate (60+24/100)
