...
######### VERY IMPORTANT BASIC ANALYSIS OF DATA
summary(data)
colnames(data)
class(data$Age)
str(head)
...
# Write CSV (If we want to extract data in a cluster and put into excel)
write.csv(data_clus_2[,1], file = "./data/data_clus_2.csv")
#It gets saved into your folder on the desktop whose path you provide in the function above.