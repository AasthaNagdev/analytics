...
frequentItems = eclat (Groceries, parameter = list(supp = 0.01, minlen= 2, maxlen = 5)) #supp= 0.01 means 0.01x9835= 98.35 -- gives the baskets containing minimum 2 and max 5 items should be purchsed atleast 98.35 times // don't put max len >10, computer might hang
