# create a time series data (UNIVARIATE- only sales of one product changing over time)
...
#Yearly----
(yearlysales = ts(sales, start=c(1980), frequency=1)) #freq=1 means yearly series
plot(yearlysales)
(yearlysales1 = ts(sales, start=c(1980,3), frequency=1)) # (1980,3) means starting from 3rd year after 1980
plot(yearlysales1)
